...
public class Plan8XWayPulseTwinNeuralStandardSteps {

    private PlanCalculatorPage planCalculatorPage;

    public Plan8XWayPulseTwinNeuralStandardSteps(PlanCalculatorPage planCalculatorPage) {
    ...
    public void user_sees_generated_saa_s_price_of(String expectedSaasPrice) {
        planCalculatorPage.pulseTwinNeuralStandardGeneratedSaasPrice(expectedSaasPrice);
    }

    @And("User sees generated Estimated ACR**:  {string}")
    public void user_sees_generated_estimated_acr(String expectedACRPrice) {
        planCalculatorPage.pulseTwinNeuralStandardGeneratedACRPrice(expectedACRPrice);
    }
