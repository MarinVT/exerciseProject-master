...
Feature: Calculator Plan 5 X Way Pulse Twin Standard
  ...
  Scenario: User is using X Way Pulse Twin Standard Plan 5 to calculate expected Saas Price financially beneficial
    ...
    And User is using "METRIC" unit for Plan 5
    And User selects a service "X Way (Pulse + Twin)" from dropdown field Select a Service for Plan 5
    And User slides the Road Length  to value of 214 km to reach Standard plan 5
    And User slides the Number of Signalized Intersections equal 145 to reach Standard plan 5
